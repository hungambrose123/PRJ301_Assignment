    ...
    <body>
        ...
        <div class="container-fluid topBar">
            <div class="row align-items-center py-3">
                <!-- logo -->
                <div class="col-4 logo"><img class="img-fluid" src="https://img.freepik.com/free-vector/flat-design-stationery-store-logo-template_23-2149758692.jpg?w=2000" alt="logo"></div>
                <!-- search function -->
        ...
        <div class="bg-dark py-3 mt-5">
            <div class="container text-light text-center">
                <p>@2023 - Văn phòng phẩm VH</p>
                <p>HungNVHE173464 - SE1740</p>
            </div>
        </div>
