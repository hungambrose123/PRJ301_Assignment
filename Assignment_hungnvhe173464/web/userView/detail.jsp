<%-- 
    Document   : detail
    Created on : Jul 10, 2023, 3:29:59 PM
    Author     : Warspite
--%>
            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a href="buy?id=${product.id}" ><button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button></a>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            ...
                            <p> Contract us from our email: hungnvhe173464@fpt.edu.vn</p>  
                        </div>
